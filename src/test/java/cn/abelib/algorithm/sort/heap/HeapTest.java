...
//        SimpleSelectionSort.println("The size: "+minPriorityQueue.size());
//        minPriorityQueue.insert(4);
//        minPriorityQueue.insert(3);
//        minPriorityQueue.insert(2);
//        SimpleSelectionSort.println("The size: "+minPriorityQueue.size());
//        SimpleSelectionSort.println("Delete the min item: "+minPriorityQueue.delMin());
//        SimpleSelectionSort.println("The size: "+minPriorityQueue.size());
//
////        Double [] a = RandomData.randDoubleArray(10, 10);
////        Double [] b = a;
////        SimpleSelectionSort.print(b);
////        Double [] c =new Double[10];
////        SimpleSelectionSort.print(c.length);
////        c[1] = 1.0;
////        SimpleSelectionSort.print(c.length);
